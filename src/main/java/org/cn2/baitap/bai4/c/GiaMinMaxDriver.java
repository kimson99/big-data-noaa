...
public class GiaMinMaxDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "MinMax Price Job C");
    job.setJarByClass(GiaMinMaxDriver.class);
    job.setMapperClass(GiaMinMaxMapper.class);
    job.setReducerClass(GiaMinMaxReducer.class);
    ...
    String outputPathStr = "hdfs://namenode:9000/baitap_output/bai4/c";
