...
public class GiaDriver {
  public static void main(String[] args) throws Exception {
    ...
    conf.set("limit.price", args[0]);

    Job job = Job.getInstance(conf, "Price Job A");
    job.setJarByClass(GiaDriver.class);
    ...
    String outputPathStr = "hdfs://namenode:9000/baitap_output/bai4/a";
