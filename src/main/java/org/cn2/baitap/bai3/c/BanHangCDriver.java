...
public class BanHangCDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Retail Job C");
    job.setJarByClass(BanHangCDriver.class);
    job.setMapperClass(BanHangCMapper.class);
    job.setReducerClass(BanHangCReducer.class);
    ...
    String outputPathStr = "hdfs://namenode:9000/baitap_output/bai3/c";
