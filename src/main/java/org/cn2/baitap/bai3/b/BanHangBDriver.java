...
public class BanHangBDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Retail Job B");
    job.setJarByClass(BanHangBDriver.class);
    job.setMapperClass(BanHangBMapper.class);
    job.setReducerClass(BanHangBReducer.class);
    ...
    String outputPathStr = "hdfs://namenode:9000/baitap_output/bai3/b";
