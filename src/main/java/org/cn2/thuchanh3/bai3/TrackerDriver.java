...
public class TrackerDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Tracker Job");
    job.setJarByClass(TrackerDriver.class);
    job.setMapperClass(TrackerMapper.class);
    job.setReducerClass(TrackerReducer.class);
    ...
    String inputPathStr = "hdfs://namenode:9000/thuchanh3/bai3/";
    String outputPathStr = "hdfs://namenode:9000/thuchanh3_output/bai3";
