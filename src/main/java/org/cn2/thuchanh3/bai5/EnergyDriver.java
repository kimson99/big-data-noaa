...
public class EnergyDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Energy Job");
    job.setJarByClass(EnergyDriver.class);
    ...
    String inputPathStr = "hdfs://namenode:9000/thuchanh3/bai5/";
    String outputPathStr = "hdfs://namenode:9000/thuchanh3_output/bai5";
