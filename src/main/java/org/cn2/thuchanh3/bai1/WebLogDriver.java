...
public class WebLogDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Web Log Job");
    ...
    String inputPathStr = "hdfs://namenode:9000/thuchanh3/bai1/";
    String outputPathStr = "hdfs://namenode:9000/thuchanh3_output/bai1";
