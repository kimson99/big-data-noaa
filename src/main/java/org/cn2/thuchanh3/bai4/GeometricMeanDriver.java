...
public class GeometricMeanDriver {
  public static void main(String[] args) throws Exception {
    ...
    Job job = Job.getInstance(conf, "Geometric Mean Job");
    job.setJarByClass(GeometricMeanDriver.class);
    job.setMapperClass(GeometricMeanMapper.class);
    job.setReducerClass(GeometricMeanReducer.class);
    ...
    String inputPathStr = "hdfs://namenode:9000/thuchanh3/bai4/";
    String outputPathStr = "hdfs://namenode:9000/thuchanh3_output/bai4";
